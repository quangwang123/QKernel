...
#define BT_LOG_PRT_DBG(fmt, arg...)	((void)0)
#define BT_LOG_PRT_INFO(fmt, arg...)	((void)0)
#define BT_LOG_PRT_WARN(fmt, arg...)	((void)0)
#define BT_LOG_PRT_ERR(fmt, arg...)	((void)0)
#define BT_LOG_PRT_INFO_RATELIMITED(fmt, arg...)	((void)0)

#define BT_LOG_PRT_DBG_RAW(p, l, fmt, ...)	((void)0)

#define BT_LOG_PRT_INFO_RAW(p, l, fmt, ...)	((void)0)

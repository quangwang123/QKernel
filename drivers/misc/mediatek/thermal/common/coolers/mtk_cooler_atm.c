...
static int cpu_target_tj = 95000;
...
static int MINIMUM_CPU_POWER = INT_MAX / 2;
static int MAXIMUM_CPU_POWER = INT_MAX / 2;
static int MINIMUM_GPU_POWER = INT_MAX / 2;
static int MAXIMUM_GPU_POWER = INT_MAX / 2;
static int MINIMUM_TOTAL_POWER = INT_MAX;
static int MAXIMUM_TOTAL_POWER = INT_MAX;
static int FIRST_STEP_TOTAL_POWER_BUDGET = 1750;
#if defined(THERMAL_VPU_SUPPORT)
static int MINIMUM_VPU_POWER = INT_MAX;
static int MAXIMUM_VPU_POWER = INT_MAX;
#endif
#if defined(THERMAL_MDLA_SUPPORT)

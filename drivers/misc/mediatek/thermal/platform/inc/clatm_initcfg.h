...
#define CLATM_INIT_CFG_0_MIN_CPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_0_MAX_CPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_0_MIN_GPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_0_MAX_GPU_PWR		(INT_MAX / 2)

#define CLATM_INIT_CFG_1_TARGET_TJ		(95000)
...
#define CLATM_INIT_CFG_1_MIN_CPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_1_MAX_CPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_1_MIN_GPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_1_MAX_GPU_PWR		(INT_MAX / 2)
...
#define CLATM_INIT_CFG_2_MIN_CPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_2_MAX_CPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_2_MIN_GPU_PWR		(INT_MAX / 2)
#define CLATM_INIT_CFG_2_MAX_GPU_PWR		(INT_MAX / 2)
